...
public class GridFragmentPagerAdapter extends FragmentPagerAdapter {
    ...
    public GridFragmentPagerAdapter(FragmentManager fm) {
        ...
        for (TransformationCategory cat : TransformationCategory.values()) {
            Fragment f = GridFragment.newInstance(cat);
            mFragments.add(f);
        }
    }
    ...
    public CharSequence getPageTitle(int position) {
        return TransformationCategory.values()[position].toString();
    }
